    ...
    <React.Fragment>
      <BrowserRouter>
        <ScrollToTop>
          <Header />
            <Switch>
                <Route exact path='http://teamilkshake.github.io/React_Books_Search_System/find' component={SearchWrapperContainer} />
                <Route exact path='http://teamilkshake.github.io/React_Books_Search_System/about' component={About} />
                <Route exact path="http://teamilkshake.github.io/React_Books_Search_System/books/:bookId"  component={Book} />
